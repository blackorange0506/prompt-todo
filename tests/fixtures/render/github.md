...
`/todoArchive`.
<!-- prompt-todo:tracker -->
Tickets are GitHub Issues of `bestpizza/app`, read with the `gh` CLI; `/todoFromTicket <N>` writes a ticket block and saves the images linked from the issue under `tickets/<N>/`.
<!-- /prompt-todo:tracker -->

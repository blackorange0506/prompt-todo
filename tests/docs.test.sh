...
check template/.claude/prompt-todo/README.md "## 7. Where things live"
check docs/todo-workflow.md "## 7. Where things live"
check docs/setup-wizard.md "## Team use"
check docs/jira-mcp.md "## Attachments"
check docs/todo-from-ticket.md "## What it never does"
check docs/app-navigation.md "## Connecting it"
check template/.claude/skills/appNavigation/SKILL.md "## Why there is no implementation here"

...
out="$(python3 "$RENDER" --config "$D/withdefault.json" --template "$TPL" --stdout)"
...
out="$(python3 "$RENDER" --config "$D/markersoff.json" --template "$TPL" --stdout)"
...
out="$(python3 "$RENDER" --config "$D/scoresoff.json" --template "$TPL" --stdout)"
